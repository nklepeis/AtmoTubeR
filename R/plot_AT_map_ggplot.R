#' @name plot_AT_map_ggplot
#'
#' @title Plot AtmoTube trajectory on a map
#'
#' @param data a tibble of AtmoTube data from Cloud API
#'
#' @author Neil E. Klepeis
#'
#' @details This function plots a static geographic map showing where the
...
plot_AT_map_ggplot <- function(data, by="1 day", streets=TRUE,
